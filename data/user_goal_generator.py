...
activity_dict_file = open('/media/minhhieu/DATA/HOC/Thesis/reinforcement_bot/reinforcement_learning_bot/data/activity_dict.json',encoding='utf-8')
    ...
    for num_inform_slot in range(1, max_num_inform_slot + 1):
        ...
        for i in range(num_inform_slot):
            ...
            while inform_slot == request_slot:
                inform_slot = random.choice(activity_list)
            # print(inform_slot)
            inform_dict[inform_slot]=random.choice(activity_dict[0][inform_slot])
...
user_goal_file = open('/media/minhhieu/DATA/HOC/Thesis/reinforcement_bot/reinforcement_learning_bot/data/activity_user_goals.json', "w",encoding='utf8')
json.dump(user_goal_list,user_goal_file,ensure_ascii=False)
